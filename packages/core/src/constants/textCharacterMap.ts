// packages/core/src/constants/text_character_map.ts

/**
 * Mapping of character codes to their displayable string representations.
 * Source: pokefirered/include/characters.h
 */
 ...
 *
 * @param byteArray - An array of numbers (bytes) representing the encoded text.
 * @returns The decoded, human-readable string.
 */
export function decodeByteArrayToString(byteArray: number[]): string {
